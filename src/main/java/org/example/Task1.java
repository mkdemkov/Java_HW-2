...
public class Task1 {
    ...
    private static void showHints() {
        System.out.println("""
                Вы можете ввести команду "/r", чтобы поставить рандомному студенту рандомную оценку.
                Команду "/l", чтобы показать список студентов с оценками.
                "/e", чтобы выйти.
                "/h", чтобы показать подсказку""".indent(1));
    }
